...
<!-- //jQuery -->
<!-- tables -->
<link rel="stylesheet" type="text/css" href="${base }/static/css/table-style.css" />
<link rel="stylesheet" type="text/css" href="${base }/static/css/basictable.css" />
<script type="text/javascript" src="${base }/static/js/jquery.basictable.min.js"></script>
